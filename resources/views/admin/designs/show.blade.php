...
<div style="max-width:1400px;margin:0 auto;">
    ...
    <div style="display:grid;grid-template-columns:1.2fr 1fr;gap:20px;">
        ...
        <div>
            <div style="background:white;border-radius:10px;padding:20px;box-shadow:0 2px 8px rgba(0,0,0,0.08);border:1px solid #e2e8f0;">
                ...
                @if($design->designImages->count() > 0)
                    <!-- Main Image Display -->
                    <div style="position:relative;margin-bottom:16px;border-radius:10px;overflow:hidden;background:#f8fafc;">
                        <div id="mainImageContainer" style="height:400px;display:flex;align-items:center;justify-content:center;">
                    ...
                    @if($design->designImages->count() > 1)
                        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(90px,1fr));gap:10px;">
                            @foreach($design->designImages as $index => $image)
                                <div onclick="showMainImage({{ $index }})"
                    ...
                    @endif
                @else
                    <div style="height:350px;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#f8fafc;border-radius:10px;">
        ...
        <div style="display:flex;flex-direction:column;gap:24px;">
            ...
            <div style="background:white;border-radius:10px;padding:20px;box-shadow:0 2px 8px rgba(0,0,0,0.08);border:1px solid #e2e8f0;">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
                    ...
                    <span style="background:#edf2f7;color:#4a5568;padding:4px 10px;border-radius:6px;font-size:13px;font-weight:600;">
                        ID: #{{ $design->id }}
                    </span>
                </div>
                ...
                <div style="display:flex;flex-direction:column;gap:12px;">
                    ...
                    <div>
                        ...
                        <div style="padding:10px;background:#f8fafc;border-radius:6px;color:#1f2937;font-size:13px;line-height:1.5;min-height:50px;">
                    ...
                    <div>
                        ...
                        <div style="padding:14px;background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);border-radius:8px;color:white;font-size:24px;font-weight:700;text-align:center;">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
                        <div>
                            ...
                            <div style="padding:10px;background:#f8fafc;border-radius:6px;color:#1f2937;font-size:13px;display:flex;align-items:center;gap:6px;">
                                <div style="width:28px;height:28px;border-radius:50%;background:#3b82f6;display:flex;align-items:center;justify-content:center;color:white;font-size:12px;font-weight:600;">
            ...
            <div style="background:white;border-radius:10px;padding:20px;box-shadow:0 2px 8px rgba(0,0,0,0.08);border:1px solid #e2e8f0;">
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(100px,1fr));gap:10px;">
                    @foreach($design->measurements as $measurement)
                        <div style="padding:12px;background:#f0fdf4;border:2px solid #86efac;border-radius:8px;text-align:center;">
                ...
                <div style="display:flex;flex-direction:column;gap:12px;">
                    ...
                    @foreach($design->designOptions->groupBy('type') as $type => $options)
                        @php
                            ...
                            $colorIndex++;
                        @endphp
                        <div style="padding:12px;background:{{ $colors['background'] }};border-radius:8px;border-left:3px solid {{ $colors['border'] }};">
                            <div style="font-size:12px;color:{{ $colors['text'] }};font-weight:600;margin-bottom:8px;text-transform:uppercase;letter-spacing:0.5px;">
                                {{ $type }}
                            </div>
                            <div style="display:flex;flex-wrap:wrap;gap:6px;">
                                @foreach($options as $option)
                                    <span style="padding:6px 12px;background:white;color:{{ $colors['text'] }};border-radius:6px;font-size:12px;font-weight:500;border:1px solid {{ $colors['itemBorder'] }};">
