...
class AddressPolicy
{
    ...
    public function viewAny(User $user): bool
    {
        ...
        throw new GeneralException('You are not authorized to view any addresses', 403);
    }
    ...
    {
        if($user->id === $address->user_id && $user->hasRole(UserRoleEnum::USER)){
            return true;
        }
    ...
    public function create(User $user): bool
    {
        ...
        throw new GeneralException('You are not authorized to create an address', 403);
    }
